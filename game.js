...
function createClouds() {
    ...
    let points = [ //chequea las esquinas de flapy
        ...
        new createjs.Point(leftX + flappy.image.width - 40, leftY),
        new createjs.Point(leftX, leftY + flappy.image.height - 25),
        new createjs.Point(leftX + flappy.image.width - 30, leftY + flappy.image.height - 10)
    ];
